...
*/}}
{{- define "tenant-manager.namespace" -}}
...
*/}}
{{- define "tenant-manager.task-scheduler.labels" -}}
helm.sh/chart: {{ include "tenant-manager.chart" . }}
{{ include "tenant-manager.task-scheduler.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
helm.sh/chart: {{ include "tenant-manager.chart" . }}
{{ include "tenant-manager.task-worker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
*/}}
{{- define "tenant-manager.tenant-manager.labels" -}}
helm.sh/chart: {{ include "tenant-manager.chart" . }}
{{ include "tenant-manager.tenant-manager.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
*/}}
{{- define "tenant-manager.tenant-manager-cli.labels" -}}
helm.sh/chart: {{ include "tenant-manager.chart" . }}
{{ include "tenant-manager.tenant-manager-cli.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
*/}}
{{- define "tenant-manager.task-scheduler.selectorLabels" -}}
app.kubernetes.io/name: {{ include "tenant-manager.name" . }}
...
*/}}
{{- define "tenant-manager.task-worker.selectorLabels" -}}
app.kubernetes.io/name: {{ include "tenant-manager.name" . }}
...
*/}}
{{- define "tenant-manager.tenant-manager.selectorLabels" -}}
app.kubernetes.io/name: {{ include "tenant-manager.name" . }}-tenant-manager
...
*/}}
{{- define "tenant-manager.tenant-manager-cli.selectorLabels" -}}
app.kubernetes.io/name: {{ include "tenant-manager.name" . }}-tenant-manager-cli
...
{{- define "tenant-manager.postgresqlName" -}}
