...
const (
	...
	// This is a special action, allowing the internal user to circumnavigate
	// dynamic checks, which are usually applied to business user (for example,
	// only accessing key configurations within a group).
	RepoActionDynamic RepoAction = "dynamic"
)
