...
func CreateRoleGroups(ctx context.Context, tb testing.TB,
	...
	auditorGroup := GetAuditorGroup(ctx)
	tenantAdminGroup := GetTenantAdminGroup(ctx)
	keyAdminGroup := GetKeyAdminGroup(ctx)
...
func CreateOtherAuditorGroup(ctx context.Context, tb testing.TB, r repo.Repo, name string, id *string) *model.Group {
	...
	group := GetOtherAuditorGroup(ctx, name, id)
	CreateTestEntities(ctx, tb, r, group)
	return group
}

func GetAuditorGroup(ctx context.Context) *model.Group {
	return GetOtherAuditorGroup(ctx, AuditorGroupName, ptr.PointTo(AuditorGroupID))
}

func GetOtherAuditorGroup(ctx context.Context, name string, id *string) *model.Group {
...
func CreateOtherTenantAdminGroup(ctx context.Context, tb testing.TB, r repo.Repo,
	...
	group := GetOtherTenantAdminGroup(ctx, name, id)
	CreateTestEntities(ctx, tb, r, group)
	return group
}

func GetTenantAdminGroup(ctx context.Context) *model.Group {
	return GetOtherTenantAdminGroup(ctx, TenantAdminGroupName, ptr.PointTo(TenantAdminGroupID))
}

func GetOtherTenantAdminGroup(ctx context.Context, name string, id *string) *model.Group {
	idStr := uuid.NewString()
	if id != nil {
		idStr = *id
	}
...
func CreateOtherKeyAdminGroup(ctx context.Context, tb testing.TB, r repo.Repo, name string, id *string) *model.Group {
	...
	group := GetOtherKeyAdminGroup(ctx, name, id)
	CreateTestEntities(ctx, tb, r, group)
	return group
}

func GetKeyAdminGroup(ctx context.Context) *model.Group {
	return GetOtherKeyAdminGroup(ctx, KeyAdminGroupName, ptr.PointTo(KeyAdminGroupID))
}

func GetOtherKeyAdminGroup(ctx context.Context, name string, id *string) *model.Group {
	idStr := uuid.NewString()
	if id != nil {
		idStr = *id
	}
