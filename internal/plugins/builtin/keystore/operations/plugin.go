...
func (p *V1Plugin) GetKey(
	ctx context.Context,
	_ *operationsv1.GetKeyRequest,
) (*operationsv1.GetKeyResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - GetKey called")

	return &operationsv1.GetKeyResponse{}, nil
}

// CreateKey generates a new key with the specified algorithm
func (p *V1Plugin) CreateKey(
	ctx context.Context,
	_ *operationsv1.CreateKeyRequest,
) (*operationsv1.CreateKeyResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - CreateKey called")

	return &operationsv1.CreateKeyResponse{}, nil
}

// DeleteKey removes a key, optionally with a deletion window
func (p *V1Plugin) DeleteKey(
	ctx context.Context,
	_ *operationsv1.DeleteKeyRequest,
) (*operationsv1.DeleteKeyResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - DeleteKey called")

	return &operationsv1.DeleteKeyResponse{}, nil
}

// EnableKey activates a previously disabled key
func (p *V1Plugin) EnableKey(
	ctx context.Context,
	_ *operationsv1.EnableKeyRequest,
) (*operationsv1.EnableKeyResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - EnableKey called")

	return &operationsv1.EnableKeyResponse{}, nil
}

// DisableKey deactivates a key while maintaining its existence
func (p *V1Plugin) DisableKey(
	ctx context.Context,
	_ *operationsv1.DisableKeyRequest,
) (*operationsv1.DisableKeyResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - DisableKey called")

	return &operationsv1.DisableKeyResponse{}, nil
}

// GetImportParameters the parameters needed for importing key material
func (p *V1Plugin) GetImportParameters(
	ctx context.Context,
	_ *operationsv1.GetImportParametersRequest,
) (*operationsv1.GetImportParametersResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - GetImportParameters called")

	return &operationsv1.GetImportParametersResponse{}, nil
}

// ImportKeyMaterial key material into a KMS key
func (p *V1Plugin) ImportKeyMaterial(
	ctx context.Context,
	_ *operationsv1.ImportKeyMaterialRequest,
) (*operationsv1.ImportKeyMaterialResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - ImportKeyMaterial called")

	return &operationsv1.ImportKeyMaterialResponse{}, nil
}

// ValidateKey the key attributes against the plugin's requirements
func (p *V1Plugin) ValidateKey(
	ctx context.Context,
	_ *operationsv1.ValidateKeyRequest,
) (*operationsv1.ValidateKeyResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - ValidateKey called")
...
func (p *V1Plugin) ValidateKeyAccessData(
	ctx context.Context,
	_ *operationsv1.ValidateKeyAccessDataRequest,
) (*operationsv1.ValidateKeyAccessDataResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - ValidateKeyAccessData called")
...
func (p *V1Plugin) TransformCryptoAccessData(
	ctx context.Context,
	_ *operationsv1.TransformCryptoAccessDataRequest,
) (*operationsv1.TransformCryptoAccessDataResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - TransformCryptoAccessData called")

	return &operationsv1.TransformCryptoAccessDataResponse{}, nil
}

// ExtractKeyRegion extracts the region from key attributes
func (p *V1Plugin) ExtractKeyRegion(
	ctx context.Context,
	_ *operationsv1.ExtractKeyRegionRequest,
) (*operationsv1.ExtractKeyRegionResponse, error) {
	slogctx.Debug(ctx, "Builtin Key Store Operations Service (KSO) - ExtractKeyRegion called")
