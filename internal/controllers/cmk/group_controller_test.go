...
func TestGetGroups(t *testing.T) {
	...
	t.Run(
		"Should code 200 on successful groups get", func(t *testing.T) {
	...
	t.Run(
		"Should code 200 on empty groups when no client data", func(t *testing.T) {
			w := testutils.MakeHTTPRequest(
				t, r, testutils.RequestOptions{
					Method:   http.MethodGet,
					Endpoint: "/groups",
...
func TestGetGroupID(t *testing.T) {
	...
	t.Run(
		"Should code 200 successful get", func(t *testing.T) {
			group := testutils.NewGroup(
				func(g *model.Group) {
	...
	t.Run(
		"Should code 400 on wrong id format", func(t *testing.T) {
			w := testutils.MakeHTTPRequest(
				t, r, testutils.RequestOptions{
					Method:   http.MethodGet,
					Endpoint: "/groups/s",
