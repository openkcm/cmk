...
// workflow config to be considered complete; otherwise it is treated as
// absent and defaults are created.
...
// are missing, so the caller treats the keystore as unset (pool/default path).
