...
var (
	...
	ErrPendingImportStateNotEditable = errors.New("key state cannot be changed while pending import")
	...
	ErrCryptoDetailsUpdate              = errors.New("crypto access data cannot be updated")
	...
	ErrPrimaryKeyDisabled        = errors.New("primary key must be enabled to perform switch action")
	...
	ErrCheckWorkflowEligibility   = errors.New("failed to check workflow eligibility")
